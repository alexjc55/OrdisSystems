...
-- Сгенерировано автоматически из рабочей базы
-- 
-- Использование для чистого развёртывания:
--   psql $DATABASE_URL -f schema_setup.sql
--
-- После этого запустить приложение — оно автоматически создаст admin-пользователя
-- через server/seed.ts при первом старте (логин: admin / пароль: admin123)
-- =============================================================================
