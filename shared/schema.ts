...
export const storeSettings = pgTable("store_settings", {
  ...
  logoUrlEn: varchar("logo_url_en", { length: 500 }),
  logoUrlHe: varchar("logo_url_he", { length: 500 }),
  logoUrlAr: varchar("logo_url_ar", { length: 500 }),
  bannerImage: varchar("banner_image", { length: 500 }),
  bannerImageEn: varchar("banner_image_en", { length: 500 }),
  bannerImageHe: varchar("banner_image_he", { length: 500 }),
  bannerImageAr: varchar("banner_image_ar", { length: 500 }),
