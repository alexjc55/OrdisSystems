...
\restrict gHE9EYzKcxBMbP8h5cbtEMjThzKPmw7HGeeYVqh6QaIAnFiYbFrX7SQGBrqW3vW
...
--
-- Name: closed_dates_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: closed_dates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: coupon_uses_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: coupon_uses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.coupons (
    ...
    min_order_amount numeric(10,2) DEFAULT '0'::numeric,
    max_uses integer,
    ...
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now(),
    usage_type character varying(20) DEFAULT 'multi'::character varying NOT NULL,
    scope character varying(20) DEFAULT 'order'::character varying NOT NULL,
    target_customer_email character varying(255),
...
--
-- Name: db_clusters; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: db_clusters_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: db_clusters_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: master_users; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: master_users_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: master_users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: pending_payments_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: pending_payments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: product_branch_availability_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: product_branch_availability_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: product_volume_discounts; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.product_volume_discounts (
    id integer NOT NULL,
    product_id integer NOT NULL,
    ...
    created_at timestamp without time zone DEFAULT now(),
    updated_at timestamp without time zone DEFAULT now(),
    CONSTRAINT product_volume_discounts_discount_type_check CHECK (((discount_type)::text = ANY ((ARRAY['percentage'::character varying, 'fixed'::character varying])::text[])))
);


--
-- Name: product_volume_discounts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.product_volume_discounts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: product_volume_discounts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.product_volume_discounts_id_seq OWNED BY public.product_volume_discounts.id;
...
CREATE TABLE public.store_settings (
    ...
    slide1_image_en character varying(500),
    slide1_image_he character varying(500),
    slide1_image_ar character varying(500),
    slide2_image_en character varying(500),
    slide2_image_he character varying(500),
    slide2_image_ar character varying(500),
    slide3_image_en character varying(500),
    slide3_image_he character varying(500),
    slide3_image_ar character varying(500),
    slide4_image_en character varying(500),
    slide4_image_he character varying(500),
    slide4_image_ar character varying(500),
    slide5_image_en character varying(500),
    slide5_image_he character varying(500),
    slide5_image_ar character varying(500),
    bottom_banner1_url_en character varying(500),
    bottom_banner1_url_he character varying(500),
    bottom_banner1_url_ar character varying(500),
    bottom_banner2_url_en character varying(500),
    bottom_banner2_url_he character varying(500),
    bottom_banner2_url_ar character varying(500),
    loyalty_discount_enabled boolean DEFAULT false,
    loyalty_discount_percent numeric(5,2) DEFAULT '0'::numeric,
    gift_enabled boolean DEFAULT false,
    gift_product_id integer,
    gift_min_order_amount numeric(10,2) DEFAULT '300'::numeric,
    gift_product_quantity numeric(10,2) DEFAULT 1,
    preorder_button_style character varying(20) DEFAULT 'tomorrow'::character varying,
    checkout_guest_first boolean DEFAULT false,
...
--
-- Name: closed_dates id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: coupon_uses id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: db_clusters id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: master_users id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: pending_payments id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: product_branch_availability id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: product_volume_discounts id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_volume_discounts ALTER COLUMN id SET DEFAULT nextval('public.product_volume_discounts_id_seq'::regclass);
...
--
-- Data for Name: closed_dates; Type: TABLE DATA; Schema: public; Owner: -
--
...
COPY public.coupon_uses (id, coupon_id, order_id, user_id, used_at) FROM stdin;
\.
...
COPY public.coupons (id, code, description, discount_type, discount_value, min_order_amount, max_uses, current_uses, is_active, expires_at, created_at, updated_at, usage_type, scope, target_customer_email, applicable_product_ids, target_user_id, stacks_with_loyalty, target_customer_emails, target_user_ids) FROM stdin;
\.


--
-- Data for Name: db_clusters; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: master_users; Type: TABLE DATA; Schema: public; Owner: -
--
...
212	79	381	100.000	52.90	52.90	2026-05-13 15:13:59.353441
213	80	382	150.000	58.80	88.20	2026-05-17 10:58:29.992973
214	81	394	100.000	78.50	78.50	2026-05-17 11:21:31.213984
215	82	394	100.000	78.50	78.50	2026-05-17 11:27:49.259469
216	83	381	100.000	52.90	52.90	2026-05-17 11:33:26.85568
217	84	381	100.000	52.90	42.40	2026-05-17 11:46:40.385475
218	85	381	150.000	52.90	63.50	2026-05-17 12:17:40.986091
219	85	380	200.000	0.00	0.00	2026-05-17 12:17:40.986091
220	86	381	600.000	52.90	254.00	2026-05-17 12:26:55.017366
221	86	380	200.000	0.00	0.00	2026-05-17 12:26:55.017366
222	87	382	150.000	58.80	70.60	2026-05-17 12:28:56.111235
223	87	381	100.000	52.90	42.40	2026-05-17 12:28:56.111235
224	87	380	200.000	0.00	0.00	2026-05-17 12:28:56.111235
225	88	381	250.000	52.90	105.80	2026-05-17 12:36:56.025887
226	88	382	150.000	58.80	70.60	2026-05-17 12:36:56.025887
227	88	380	200.000	0.00	0.00	2026-05-17 12:36:56.025887
228	89	381	200.000	52.90	84.70	2026-05-17 13:51:10.344036
229	89	382	100.000	58.80	47.10	2026-05-17 13:51:10.344036
230	90	381	100.000	52.90	42.40	2026-05-17 13:52:59.251054
231	90	382	100.000	58.80	47.10	2026-05-17 13:52:59.251054
232	90	380	200.000	0.00	0.00	2026-05-17 13:52:59.251054
\.
...
COPY public.orders (id, user_id, status, total_amount, customer_notes, delivery_address, payment_method, created_at, updated_at, customer_phone, requested_delivery_time, delivery_date, delivery_time, cancellation_reason, guest_name, guest_email, guest_phone, delivery_fee, guest_access_token, guest_access_token_expires, guest_claim_token, order_language, branch_id, coupon_code, coupon_discount, loyalty_discount, gift_product_id, discount_details) FROM stdin;
11	\N	pending	211.90	\N	Dostavka 5	Картой по телефону или в магазине	2025-06-19 11:35:44.640522	2025-06-19 11:35:44.640522	\N	\N	2025-06-19	17:00 - 19:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
13	\N	pending	156.80	\N	Asdfghjjbg 56	Картой по телефону или в магазине	2025-06-19 12:04:49.649031	2025-06-19 12:04:49.649031	12345678887	\N	2025-06-19	17:00 - 19:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
16	admin	pending	173.70	\N	Stadia Gaon 6, Haifa	Картой по телефону или в магазине	2025-06-19 16:06:08.614807	2025-06-24 15:39:37.611	0528496528	\N	2025-06-24	19:00 - 21:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
9	43948959	preparing	58.80		Saadia Gaon 6/2, Haifa	Картой по телефону или в магазине	2025-06-19 00:54:00.374156	2025-06-20 11:26:00.399	+972528496528	\N	2025-06-25	11:00 - 13:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
12	\N	preparing	58.80	\N	Stadia Gaon 6, Haifa	Картой по телефону или в магазине	2025-06-19 12:00:43.867789	2025-07-01 23:00:18.548	0528496528	\N	2025-06-19	19:00 - 21:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
31	admin	pending	223.80	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-09-03 14:53:19.198057	2025-09-03 14:53:19.198057	0528496528	\N	2025-09-04		\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
32	admin	pending	126.70	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-09-03 16:36:32.086084	2025-09-03 16:36:32.086084	0528496528	\N	2025-09-05	13:00 - 15:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
33	\N	pending	40.00	\N	Тестовый адрес 123	cash	2025-09-05 11:32:47.557223	2025-09-05 11:32:47.557223	\N	\N	2024-01-15	10:00-12:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
1	43948959	ready	92.72	\n[DISCOUNTS:{"orderDiscount":{"type":"percentage","value":5,"reason":""},"itemDiscounts":null}]		cash	2025-06-17 19:00:50.571966	2025-07-06 15:00:13.023		\N			\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
2	43948959	preparing	136.76	\n[DISCOUNTS:{"orderDiscount":{"type":"percentage","value":10,"reason":""},"itemDiscounts":{"1":{"type":"percentage","value":5,"reason":""},"2":{"type":"amount","value":20,"reason":""}}}]	Haifa, Saadia Gaon 6	cash	2025-06-18 13:09:54.933499	2025-06-23 12:22:16.333	+972528496528	\N	2025-06-19	18:00-20:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
18	admin	pending	155.00	\n[ORDER_DATA:{"orderDiscount":{"type":"percentage","value":10,"reason":""},"itemDiscounts":null,"manualPriceOverride":{"enabled":true,"value":155}}]	Stadia Gaon 6, Haifa	Картой по телефону или в магазине	2025-06-30 08:24:30.370992	2025-07-05 23:05:19.231	0528496528	\N	2025-07-01	13:00 - 15:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
17	admin	confirmed	115.00	\n[ORDER_DATA:{"orderDiscount":{"type":"percentage","value":10,"reason":"так"},"itemDiscounts":{"1":{"type":"percentage","value":5,"reason":""}},"manualPriceOverride":{"enabled":true,"value":100}}]	Stadia Gaon 6, Haifa	Картой по телефону или в магазине	2025-06-20 13:31:40.324299	2025-07-05 23:05:26.64	0528496528	\N	2025-06-20	09:00 - 11:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
34	\N	pending	40.00	\N	Тестовый адрес 123	cash	2025-09-05 11:35:49.08552	2025-09-05 11:35:49.08552	\N	\N	2024-01-15	10:00-12:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
14	\N	preparing	156.80	\N	Adress 123	Картой по телефону или в магазине	2025-06-19 12:10:31.229895	2025-07-05 23:05:35.538	1234567896543	\N	2025-06-19	19:00 - 21:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
20	\N	pending	60.10	\N	dsfdg fgdfgh5	Банковская карта по телефону	2025-07-06 13:43:41.592623	2025-07-06 13:43:41.592623	\N	\N	2025-07-07		\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
3	43948959	pending	144.90	\N	Saadia Gaon 6/2, Haifa	cash	2025-06-18 15:46:57.762544	2025-06-18 15:46:57.762544	+972528496528	\N	\N	\N	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
4	43948959	pending	151.50	\N	Saadia Gaon 6/2, Haifa	cash	2025-06-18 16:03:52.340736	2025-06-18 16:03:52.340736	+972528496528	\N	2025-06-19	12:00-14:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
5	\N	pending	170.70		врврпарпа	cash	2025-06-18 20:20:38.960862	2025-06-18 22:55:36.968	543645645654	\N			\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
6	43948959	pending	58.80	\N	Saadia Gaon 6/2, Haifa	\N	2025-06-18 23:51:11.741996	2025-06-18 23:51:11.741996	\N	\N	\N	\N	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
7	43948959	pending	77.00	\N	Saadia Gaon 6/2, Haifa	\N	2025-06-19 00:16:26.722272	2025-06-19 00:16:26.722272	+972528496528	\N	2025-07-04	13:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
8	43948959	pending	52.90	\N	Saadia Gaon 6/2, Haifa	\N	2025-06-19 00:39:48.609281	2025-06-19 00:39:48.609281	+972528496528	\N	2025-06-25	17:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
10	\N	pending	45.10	\N	Haifa, S Gaon 6	Картой по телефону или в магазине	2025-06-19 05:30:31.161009	2025-06-19 05:30:31.161009	+9733396528	\N	2025-06-19	13:00 - 15:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
29	admin	pending	92.00	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-07-09 07:09:35.190858	2025-07-09 07:09:35.190858	0528496528	\N	2025-07-10	11:00 - 13:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
30	admin	cancelled	98.60	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-07-09 07:30:14.905505	2025-07-11 06:50:34.902	0528496528	\N	2025-07-10		Другое	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
28	admin	confirmed	377.50	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-07-06 17:21:08.120672	2025-07-17 13:47:59.499	0528496528	\N	2025-07-07	13:00 - 15:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
35	\N	pending	40.00	\N	Тестовый адрес 123	cash	2025-09-05 11:46:25.689844	2025-09-05 11:46:25.689844	\N	\N	2024-01-15	10:00-12:00	\N	Иван Петров	ivan@example.com	123456789	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
36	\N	pending	40.00	\N	Новый тестовый адрес 456	card	2025-09-05 11:56:44.751132	2025-09-05 11:56:44.751132	\N	\N	2024-01-20	14:00-16:00	\N	Анна Смирнова	anna@example.com	987654321	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
37	\N	pending	126.70	\N	Haifa, S Gaon 6	Банковская карта по телефону	2025-09-05 12:12:50.458949	2025-09-05 12:12:50.458949	\N	\N	2025-09-07	10:00 - 12:00	\N	Test Testovich	test@test.com	0500000000	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
38	\N	pending	40.00	\N	Тестовый адрес 123	cash	2025-09-05 12:18:02.716598	2025-09-05 12:18:02.716598	\N	\N	2024-01-21	15:00-17:00	\N	Тест Пользователь	test@example.com	123456789	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
39	\N	pending	65.00	\N	Улица Тестовая 456	card	2025-09-05 12:18:24.353759	2025-09-05 12:18:24.353759	\N	\N	2024-01-22	12:00-14:00	\N	Алексей Тестович	testuser@example.com	987654321	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
40	\N	pending	40.00	\N	Debug Street 789	cash	2025-09-05 12:19:03.389223	2025-09-05 12:19:03.389223	\N	\N	2024-01-23	16:00-18:00	\N	Отладка Email	debug@example.com	111222333	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
41	\N	pending	40.00	\N	Final Test St 999	card	2025-09-05 12:20:08.943289	2025-09-05 12:20:08.943289	\N	\N	2024-01-24	18:00-20:00	\N	Финальный Тест	final@test.com	999888777	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
42	\N	pending	244.30	\N	Haifa, S Gaon 6	Банковская карта по телефону	2025-09-05 12:34:54.474461	2025-09-05 12:34:54.474461	\N	\N	2025-09-07	12:00 - 14:00	\N	Alex Суздальцева	alex@gmail.com	0521234567	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
43	\N	pending	27.50	\N	Test Email Street 123	cash	2025-09-05 12:36:18.689549	2025-09-05 12:36:18.689549	\N	\N	2024-01-25	10:00-12:00	\N	EMAIL TEST	test.email@example.com	555444333	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
44	\N	pending	126.70	\N	Test Address pMiyag	Наличными в магазине	2025-09-12 09:35:27.441396	2025-09-12 09:35:27.441396	\N	\N	2025-09-14	10:00 - 12:00	\N	TestGuestWoB3 UserIMVG	testguests4rlHZ@example.com	+9725YIb7A_0Q	0.00	9be6f962367c1dbc4070c58b540b2bb32a86fd6261de33bc8da74916eb8c2943	2025-10-12 09:35:27.275	47032ff7a338557f840930bd38057d13d14c9915707470347edb6c49283011b6	ru	\N	\N	\N	\N	\N	\N
...
48	\N	pending	120.80	\N	123 Test Street		2025-09-12 10:29:52.649121	2025-09-12 10:29:52.649121	\N	\N			\N	Guest User	guest.user@example.com	+972555123456	0.00	990ce98de1158f7375e37d1223b64ba29638715078dca215071fba3bcd28b3cb	2025-10-12 10:29:52.136	e23c1a71d80e7c17a0f673d13769f1c6e2185485437407666cb02964ad582288	ru	\N	\N	\N	\N	\N	\N
...
50	\N	pending	113.00	\N	Тель Авив, Улица 11	Банковская карта по телефону	2025-09-12 14:09:06.683593	2025-09-12 14:09:06.683593	\N	\N	2025-09-14	14:00 - 16:00	\N	Alex Ssss	alexjc55@yandex.ru	972533396528	0.00	099b41b2bea94c32085941bda554b09cc2bc9f214d0d5676128ac3049ed8585e	2025-10-12 14:09:06.666	3ec6f61c0c1004812338cf4318a6fe11e747b5def0b11e69c7416d291306a1a7	ru	\N	\N	\N	\N	\N	\N
51	admin	pending	67.90	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-09-12 14:11:38.37626	2025-09-12 14:11:38.37626	0528496528	\N	2025-09-14	12:00 - 14:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
52	43948959	pending	67.90	\N	Saadia Gaon 6/2, Haifa	Банковская карта по телефону	2025-09-12 14:14:56.023213	2025-09-12 14:14:56.023213	+972528496528	\N	2025-09-14	16:00 - 18:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
53	\N	pending	67.90	\N	Тель Авив, Улица 11	Наличными в магазине	2025-09-12 19:32:54.818653	2025-09-12 19:32:54.818653	\N	\N	2025-09-14	10:00 - 12:00	\N	Тестовый Пользователь		0521234567	0.00	964d75498f118f9bbd1329661e6bef85cb6020b4a5007ad9b0ce667ac1d28743	2025-10-12 19:32:54.25	49bad0a38d453a216b6fb470aca0995d9dad958dd7cf7091c3442f78027d7b4b	ru	\N	\N	\N	\N	\N	\N
54	\N	pending	67.90	\N	Хайфа, Центральная 5	Наличными в магазине	2025-09-12 19:39:23.301053	2025-09-12 19:39:23.301053	\N	\N	2025-09-14	10:00 - 12:00	\N	Тестовый2 Пользователь2	valid@example.com	0529876543	0.00	ec769f1b65256d416384622062ab50aa5c875a90a2130c2e38d769ff48214a72	2025-10-12 19:39:22.74	0f77c66116908df205c079bb72d23e90876fbc03f1db9164eb5bf0b293a39584	ru	\N	\N	\N	\N	\N	\N
...
62	admin	pending	194.90	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-09-21 19:35:13.558838	2025-09-21 19:35:13.558838	0528496528	\N	2025-09-28	14:00 - 16:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
63	\N	pending	219.50	\N	sadjhsak sadghjashd	Банковская карта по телефону	2025-09-21 20:19:56.782856	2025-09-21 20:19:56.782856	\N	\N	2025-09-26	11:00 - 13:00	\N	tetst testst	ttestst@gmail.com	87268635423578	0.00	689ea23f8eee32ef634f5406b9f115721105c4908f0175a016f5d02ee5570a62	2025-10-21 20:19:56.627	e8c95f5f6e4990af9dbd830f81301503de3b95bd8c3e4df33fdd1cabfc24f9cb	ru	\N	\N	\N	\N	\N	\N
64	admin	pending	73.80	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-09-24 13:36:48.463287	2025-09-24 13:36:48.463287	0528496528	\N	2025-09-25	13:00 - 15:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
65	admin	pending	126.70		Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-10-16 07:29:22.672683	2025-10-16 07:30:22.21	0528496528	\N	2025-10-17		\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
66	admin	pending	67.90	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-10-16 07:31:13.828681	2025-10-16 07:31:13.828681	0528496528	\N	2025-10-16	half_day_second	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
67	admin	pending	126.70	\N	Stadia Gaon 6, Haifa		2025-10-16 07:45:02.305741	2025-10-16 07:45:02.305741	0528496528	\N	2025-10-16	half_day_second	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
68	admin	pending	67.90	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-10-16 07:54:08.756828	2025-10-16 07:54:08.756828	0528496528	\N	2025-10-16	half_day_second	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
69	admin	pending	67.90	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-10-16 08:06:53.931701	2025-10-16 08:06:53.931701	0528496528	\N	2025-10-17	half_day_second	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
70	admin	pending	73.80	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-10-16 08:13:59.201558	2025-10-16 08:13:59.201558	0528496528	\N	2025-10-17	half_day_first	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
71	admin	pending	67.90	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2025-10-30 13:56:36.659901	2025-10-30 13:56:36.659901	0528496528	\N	2025-10-30	half_day_second	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
72	admin	pending	67.90	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2026-02-09 11:14:01.961942	2026-02-09 11:14:01.961942	0528496528	\N	2026-02-19	half_day_second	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
73	admin	pending	1115.10	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2026-02-09 11:18:25.418394	2026-02-09 11:18:25.418394	0528496528	\N	2026-02-19	half_day_first	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
74	admin	pending	257.00	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2026-02-25 11:21:01.679971	2026-02-25 11:21:01.679971	0528496528	\N	2026-02-26	half_day_second	\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
75	admin	pending	185.50	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2026-04-14 06:47:42.798737	2026-04-14 06:47:42.798737	0528496528	\N	2026-04-14	14:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	3	\N	\N	\N	\N	\N
76	worker	pending	109.30		jkhsdkjhd 344	Банковская карта по телефону	2026-04-14 08:25:04.837362	2026-05-09 20:42:55.035	71653761548732	\N	2026-04-14	16:00	\N	\N	\N	\N	0.00	\N	\N	\N	ru	1	\N	\N	\N	\N	\N
77	admin	pending	165.90	\N	Stadia Gaon 6, Haifa	Наличными в магазине	2026-05-11 15:01:47.393011	2026-05-11 15:01:47.393011	0528496528	\N	2026-05-13		\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
78	admin	pending	165.81		Stadia Gaon 6, Haifa	Наличными в магазине	2026-05-11 15:02:33.859317	2026-05-11 15:46:16.31	0528496528	\N	2026-05-13		\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
79	admin	pending	67.90	\N	Stadia Gaon 6, Haifa	Наличными в магазине	2026-05-13 15:13:59.353441	2026-05-13 15:13:59.353441	0528496528	\N	2026-05-13		\N	\N	\N	\N	0.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
80	admin	pending	94.38	\N	Stadia Gaon 6, Haifa	Банковская карта по телефону	2026-05-17 10:58:29.992973	2026-05-17 10:58:29.992973	0528496528	\N	2026-05-17		\N	\N	\N	\N	15.00	\N	\N	\N	ru	\N	GO	8.82	\N	\N	{"coupon": {"code": "GO", "type": "percentage", "value": 10, "discountAmount": 8.82}}
81	admin	pending	93.50	\N	Stadia Gaon 6, Haifa	Наличными в магазине	2026-05-17 11:21:31.213984	2026-05-17 11:21:31.213984	0528496528	\N	2026-05-17		\N	\N	\N	\N	15.00	\N	\N	\N	ru	\N	\N	\N	\N	\N	\N
82	admin	pending	85.65	\N	Stadia Gaon 6, Haifa	Наличными в магазине	2026-05-17 11:27:49.259469	2026-05-17 11:27:49.259469	0528496528	\N	2026-05-17		\N	\N	\N	\N	15.00	\N	\N	\N	ru	\N	\N	\N	7.85	\N	{"loyalty": {"percent": 10, "discountAmount": 7.85}}
83	admin	pending	62.61	\N	Stadia Gaon 6, Haifa	Наличными в магазине	2026-05-17 11:33:26.85568	2026-05-17 11:33:26.85568	0528496528	\N	2026-05-17		\N	\N	\N	\N	15.00	\N	\N	\N	ru	\N	\N	\N	5.29	\N	{"loyalty": {"percent": 10, "discountAmount": 5.29}}
84	admin	pending	53.16	\N	Stadia Gaon 6, Haifa	Наличными в магазине	2026-05-17 11:46:40.385475	2026-05-17 11:46:40.385475	0528496528	\N	2026-05-17		\N	\N	\N	\N	15.00	\N	\N	\N	ru	\N	\N	\N	4.24	\N	{"loyalty": {"percent": 10, "discountAmount": 4.24}}
85	admin	pending	72.15	\N	Stadia Gaon 6, Haifa	Наличными в магазине	2026-05-17 12:17:40.986091	2026-05-17 12:17:40.986091	0528496528	\N	2026-05-17		\N	\N	\N	\N	15.00	\N	\N	\N	ru	\N	\N	\N	6.35	380	{"gift": {"productId": 380, "productName": "Абжерка"}, "loyalty": {"percent": 10, "discountAmount": 6.35}}
86	admin	pending	243.60	\N	Stadia Gaon 6, Haifa	Наличными в магазине	2026-05-17 12:26:55.017366	2026-05-17 12:26:55.017366	0528496528	\N	2026-05-17		\N	\N	\N	\N	15.00	\N	\N	\N	ru	\N	\N	\N	25.40	380	{"gift": {"productId": 380, "productName": "Абжерка"}, "loyalty": {"percent": 10, "discountAmount": 25.4}}
87	admin	pending	116.70	\N	Stadia Gaon 6, Haifa	Наличными в магазине	2026-05-17 12:28:56.111235	2026-05-17 12:28:56.111235	0528496528	\N	2026-05-17		\N	\N	\N	\N	15.00	\N	\N	\N	ru	\N	\N	\N	11.30	380	{"gift": {"productId": 380, "productName": "Абжерка"}, "loyalty": {"percent": 10, "discountAmount": 11.3}}
88	admin	pending	173.76	\N	Stadia Gaon 6, Haifa	Наличными в магазине	2026-05-17 12:36:56.025887	2026-05-17 12:36:56.025887	0528496528	\N	2026-05-17		\N	\N	\N	\N	15.00	\N	\N	\N	ru	\N	\N	\N	17.64	380	{"gift": {"productId": 380, "productName": "Абжерка"}, "loyalty": {"percent": 10, "discountAmount": 17.64}}
89	admin	pending	120.44	\N	Stadia Gaon 6, Haifa	Наличными в магазине	2026-05-17 13:51:10.344036	2026-05-17 13:51:10.344036	0528496528	\N	2026-05-17		\N	\N	\N	\N	15.00	\N	\N	\N	ru	\N	GO	13.18	13.18	\N	{"coupon": {"code": "GO", "type": "percentage", "value": 10, "discountAmount": 13.18, "stacksWithLoyalty": true}, "loyalty": {"percent": 10, "discountAmount": 13.18}}
90	admin	pending	45.55	\N	Stadia Gaon 6, Haifa	Наличными в магазине	2026-05-17 13:52:59.251054	2026-05-17 13:52:59.251054	0528496528	\N	2026-05-17		\N	\N	\N	\N	15.00	\N	\N	\N	ru	\N	GO	50.00	8.95	380	{"gift": {"productId": 380, "productName": "Абжерка"}, "coupon": {"code": "GO", "type": "fixed", "value": 50, "discountAmount": 50, "stacksWithLoyalty": true}, "loyalty": {"percent": 10, "discountAmount": 8.95}}
\.
...
COPY public.pending_payments (id, token, order_data, order_items, user_id, status, transaction_id, created_at, expires_at) FROM stdin;
\.


--
-- Data for Name: product_branch_availability; Type: TABLE DATA; Schema: public; Owner: -
--
...
129	380	47	2026-05-13 08:18:31.855429
130	382	47	2026-05-13 08:41:29.310723
131	381	47	2026-05-13 08:41:59.009777
\.


--
-- Data for Name: product_volume_discounts; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.product_volume_discounts (id, product_id, min_quantity, discount_type, discount_value, is_active, created_at, updated_at) FROM stdin;
\.
...
382	Баклажаны по-азиатски	Маринованные баклажаны с чесноком и кориандром	58.80		t	in_stock	1	2025-06-17 18:46:47.892589	2026-05-13 08:41:29.267	t	58.80	100g	t	percentage	20.00	available		חציל באסיה			חציל כבוש עם שום וכוסברה					\N				
...
380	Абжерка	Острый грузинский салат с овощами и зеленью	45.01	/uploads/optimized/image-1752438250252-66041097.jpg	t	in_stock	0	2025-06-17 18:46:47.892589	2026-05-13 08:18:31.844	t	45.01	100g	t	percentage	20.00	out_of_stock_today		אסירקה			סלט גרוזיני חד עם ירקות ועשבי תיבול					025874	**Что-то вкусное** 100г\r\nЧто-то не очень вкусное 20г\r\nМясо белого медведя 300г		** משהו טעים ** 100 גרם\r\nמשהו לא טעים במיוחד 20 גרם\r\nבשר דוב לבן 300 גרם	
381	Аджика	Острая закуска из помидоров, перца и специй	52.90		t	in_stock	2	2025-06-17 18:46:47.892589	2026-05-13 08:41:58.999	t	52.90	100g	t	percentage	20.00	available		אדזיקה			חטיף חריף מעגבניות, פלפל ותבלינים					290001				
...
yivI5MLBkVC0pqxz62qBM4_vi3ubuaHr	{"cookie":{"originalMaxAge":86400000,"expires":"2026-05-25T12:10:01.833Z","secure":false,"httpOnly":true,"path":"/"},"passport":{"user":"admin"}}	2026-05-26 10:18:56
\.
...
--
-- Name: closed_dates_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.closed_dates_id_seq', 16, true);


--
-- Name: coupon_uses_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.coupon_uses_id_seq', 3, true);
...
--
-- Name: db_clusters_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: master_users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('public.order_items_id_seq', 232, true);
...
--
-- Name: pending_payments_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.pending_payments_id_seq', 3, true);


--
-- Name: product_branch_availability_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('public.product_categories_id_seq', 131, true);


--
-- Name: product_volume_discounts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.product_volume_discounts_id_seq', 1, false);
...
--
-- Name: closed_dates closed_dates_date_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: db_clusters db_clusters_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: db_clusters db_clusters_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: master_users master_users_email_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: master_users master_users_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pending_payments pending_payments_token_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pending_payments
    ADD CONSTRAINT pending_payments_token_key UNIQUE (token);
...
--
-- Name: product_branch_availability product_branch_availability_product_id_branch_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: product_volume_discounts product_volume_discounts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_volume_discounts
    ADD CONSTRAINT product_volume_discounts_pkey PRIMARY KEY (id);
...
--
-- Name: idx_pending_payments_expires_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pending_payments_expires_at ON public.pending_payments USING btree (expires_at);


--
-- Name: idx_pending_payments_token; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pending_payments_token ON public.pending_payments USING btree (token);


--
-- Name: orders_guest_access_token_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: orders_guest_claim_token_unique; Type: INDEX; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.coupon_uses
    ADD CONSTRAINT coupon_uses_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);


--
-- Name: coupons coupons_target_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coupons
    ADD CONSTRAINT coupons_target_user_id_fkey FOREIGN KEY (target_user_id) REFERENCES public.users(id);
...
--
-- Name: pending_payments pending_payments_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: product_volume_discounts product_volume_discounts_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_volume_discounts
    ADD CONSTRAINT product_volume_discounts_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE CASCADE;
...
\unrestrict gHE9EYzKcxBMbP8h5cbtEMjThzKPmw7HGeeYVqh6QaIAnFiYbFrX7SQGBrqW3vW
