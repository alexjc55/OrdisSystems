...
import { AdaptiveBanner } from "@/components/ui/adaptive-banner";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden pt-16">
      ...
      {/* Bottom Banners - Fully adaptive to image aspect ratios */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {storeSettings?.bottomBanner1Url && (
                <AdaptiveBanner
                  ...
                  alt={t('banner1')}
                  link={storeSettings?.bottomBanner1Link}
                />
              )}
              ...
              {storeSettings?.bottomBanner2Url && (
                <AdaptiveBanner
                  ...
                  alt={t('banner2')}
                  link={storeSettings?.bottomBanner2Link}
                />
              )}
            </div>
          </div>
