  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexWrap: 'nowrap', gap: 0, marginTop: 10, direction: 'ltr' }}>
      ...
      {provider === 'grow' ? (
        ...
        /* AllPay: PCI DSS + VISA, MC, Diners, Discover, JCB, AMEX, Apple Pay, Bit */
        <>
          ...
          <span style={{ color: '#e5e7eb', fontSize: 12, flexShrink: 0, paddingRight: 8 }}>|</span>
          {/* VISA */}
          <span style={{ fontFamily: 'Arial, sans-serif', fontWeight: 900, fontStyle: 'italic', fontSize: 13, color: '#9ca3af', lineHeight: 1, userSelect: 'none', flexShrink: 0, whiteSpace: 'nowrap', paddingRight: 5 }}>VISA</span>
          {/* Mastercard */}
          <svg width="22" height="14" viewBox="0 0 38 24" aria-label="Mastercard" style={{ flexShrink: 0, marginRight: 5 }}>
          ...
          {/* Diners Club */}
          <svg width="14" height="14" viewBox="0 0 24 24" aria-label="Diners Club" style={{ flexShrink: 0, marginRight: 5 }}>
            <circle cx="12" cy="12" r="11" fill="none" stroke="#9ca3af" strokeWidth="2"/>
            <ellipse cx="10" cy="12" rx="5" ry="8" fill="none" stroke="#9ca3af" strokeWidth="1.5"/>
            <ellipse cx="14" cy="12" rx="5" ry="8" fill="none" stroke="#9ca3af" strokeWidth="1.5"/>
          </svg>
          {/* Discover */}
          <span style={{ fontFamily: 'Arial, sans-serif', fontWeight: 700, fontSize: 10, color: '#9ca3af', lineHeight: 1, userSelect: 'none', flexShrink: 0, whiteSpace: 'nowrap', paddingRight: 5, letterSpacing: '0.3px' }}>DISC</span>
          {/* JCB */}
          <span style={{ fontFamily: 'Arial, sans-serif', fontWeight: 800, fontSize: 10, color: '#9ca3af', lineHeight: 1, userSelect: 'none', flexShrink: 0, whiteSpace: 'nowrap', paddingRight: 5 }}>JCB</span>
          {/* AMEX */}
