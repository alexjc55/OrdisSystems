        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-white/80 leading-relaxed">
                {adminT('storeSettings.basicInfoDescription', 'Название магазина, контактная информация')}
              </p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-white/80 leading-relaxed">
                {adminT('storeSettings.workingHoursDescription', 'Режим работы по дням недели')}
              </p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-white/80 leading-relaxed">
                {adminT('storeSettings.deliveryPaymentDescription', 'Способы доставки и оплаты')}
              </p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-white/80 leading-relaxed">
                {adminT('storeSettings.languageDescription', 'Языки интерфейса и локализация')}
              </p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-white/80 leading-relaxed">
                {adminT('storeSettings.trackingDescription', 'Коды аналитики и отслеживания')}
              </p>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm">{adminT('storeSettings.minOrderAmount')}</FormLabel>
                      <FormControl>
                        <Input 
                          type="number"
                          placeholder={adminT('storeSettings.minOrderAmountPlaceholder')} 
                          {...field} 
                          className="text-sm" 
                        />
                      </FormControl>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input 
                          type="number"
                          placeholder={adminT('storeSettings.deliveryFeePlaceholder')} 
                          {...field} 
                          className="text-sm" 
                        />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm">{adminT('storeSettings.currency')}</FormLabel>
                      <FormControl>
                        <Input placeholder={adminT('storeSettings.currencyPlaceholder')} {...field} className="text-sm" />
                      </FormControl>
                      <FormMessage className="text-xs" />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm">{adminT('storeSettings.timezone')}</FormLabel>
                      <FormControl>
                        <Input placeholder={adminT('storeSettings.timezonePlaceholder')} {...field} className="text-sm" />
                      </FormControl>
                      <FormMessage className="text-xs" />
                    </FormItem>
                  )}
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 gap-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm">{adminT('storeSettings.storeNameEn')}</FormLabel>
                      <FormControl>
                        <Input placeholder={adminT('storeSettings.storeNameEnPlaceholder')} {...field} className="text-sm" />
                      </FormControl>
                      <FormMessage className="text-xs" />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm">{adminT('storeSettings.storeNameHe')}</FormLabel>
                      <FormControl>
                        <Input placeholder={adminT('storeSettings.storeNameHePlaceholder')} {...field} className="text-sm" />
                      </FormControl>
                      <FormMessage className="text-xs" />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm">{adminT('storeSettings.storeDescriptionEn')}</FormLabel>
                      <FormControl>
                        <Textarea 
                          placeholder={adminT('storeSettings.storeDescriptionEnPlaceholder')} 
                          {...field} 
                ...
                <FormField
                  control={form.control}
                  name="storeDescriptionHe"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm">{adminT('storeSettings.storeDescriptionHe')}</FormLabel>
                      <FormControl>
                        <Textarea 
                          placeholder={adminT('storeSettings.storeDescriptionHePlaceholder')} 
                          {...field} 
                          className="text-sm min-h-[80px]" 
                        />
                      </FormControl>
          ...
          <DialogContent className="sm:max-w-2xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm">{adminT('storeSettings.trackingCode')}</FormLabel>
                    <FormControl>
                      <Textarea 
                        placeholder={adminT('storeSettings.trackingCodePlaceholder')} 
                        {...field} 
