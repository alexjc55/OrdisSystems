...
export default function AdminDashboard() {
  ...
  // Get store settings for worker permissions
  ...
  const hasPermission = (permission: string) => {
    ...
    const workerPermissions = storeSettings?.workerPermissions;
    if (!workerPermissions) return false;
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <Tabs defaultValue="products" className="space-y-6">
          <TabsList className="grid w-full grid-cols-4">
            {hasPermission('canManageProducts') && <TabsTrigger value="products">Товары</TabsTrigger>}
            {hasPermission('canManageProducts') && <TabsTrigger value="categories">Категории</TabsTrigger>}
            {hasPermission('canManageOrders') && <TabsTrigger value="orders">Заказы</TabsTrigger>}
            {hasPermission('canManageUsers') && <TabsTrigger value="users">Пользователи</TabsTrigger>}
          </TabsList>
