...
export default function OrganizedStoreSettings({ storeSettings, onSubmit, isLoading }: OrganizedStoreSettingsProps) {
  const form = useForm({
    ...
    defaultValues: {
      ...
      workingHours: {
        monday: (storeSettings?.workingHours as any)?.monday || "",
        tuesday: (storeSettings?.workingHours as any)?.tuesday || "",
        wednesday: (storeSettings?.workingHours as any)?.wednesday || "",
        thursday: (storeSettings?.workingHours as any)?.thursday || "",
        friday: (storeSettings?.workingHours as any)?.friday || "",
        saturday: (storeSettings?.workingHours as any)?.saturday || "",
        sunday: (storeSettings?.workingHours as any)?.sunday || "",
      },
