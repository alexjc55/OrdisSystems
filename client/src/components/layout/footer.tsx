...
export function Footer() {
  ...
  return (
    <footer className="w-screen bg-[#333333] py-4" style={{ marginLeft: 'calc(-50vw + 50%)', marginRight: 'calc(-50vw + 50%)' }} dir="ltr">
      <div className="max-w-[1023px] mx-auto px-4 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3">
        <img 
          src={ordisLogo} 
          alt="Ordis" 
          ...
          onClick={handleClick}
        />
        <span className="text-white text-xs sm:text-sm font-medium text-center sm:text-left">
          {t('footer.poweredBy')} 
          <span 
