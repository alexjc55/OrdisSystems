...
export function WhatsAppChat() {
  ...
  return (
    <button
      ...
      className="whatsapp-button fixed bottom-[130px] md:bottom-6 right-4 w-12 h-12 md:w-16 md:h-16 z-[58] bg-green-500 hover:bg-green-600 text-white rounded-full shadow-xl transition-all duration-300 hover:scale-110 flex items-center justify-center"
