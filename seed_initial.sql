...
--    Активируется автоматически. Изображения добавьте через раздел "Темы".
-- -----------------------------------------------------------------------------
INSERT INTO themes (
    id,
    name,
    ...
    tomorrow_color,
    tomorrow_dark_color,
    tomorrow_light_color,
    out_of_stock_color,
    working_hours_icon_color,
    contacts_icon_color,
    payment_delivery_icon_color,
    white_color,
    gray50_color,
    gray100_color,
    gray200_color,
...
VALUES (
    ...
    5000,
    'fade',
    '',   -- logo_url: загрузите через админку → Темы → Редактировать
    '',   -- banner_image_url: загрузите через админку → Темы → Редактировать
    '', '', '',
    '', '', '',
    NOW(),
    NOW()
